...
const Rules = () => {
  ...
  return (
    <div className="flex items-center justify-center md:justify-end">
      <button
        onClick={openDialog}
        className="font-semibold font-barlow text-[16px] tracking-[2.5px] text-white uppercase border-2 border-white px-16 py-3 rounded-lg
         md:absolute md:right-[5%] md:bottom-[5%] md:text-greyishBlue md:bg-white md:px-10 "
      >
        Rules
      </button>
      ...
      <dialog
        ref={dialogRef}
        className=" grid absolute w-full h-full top-0 items-center justify-center align-middle text-center
                     md:w-fit md:h-fit md:p-10 md:top-[50%]  md:translate-y-[-50%] md:grid-rows-[auto,auto] md:grid-cols-[auto,auto,auto] md:gap-y-10 md:rounded-lg
                     backdrop:bg-[rgb(0,0,0,0.6)]"
      >
        <h2 className="font-bold font-barlow text-[32px] text-greyishBlue leading-none md:row-start-1 md:col-start-1 md:col-end-1">
          Rules
        </h2>
        <svg
          className="md:row-start-2 md:col-start-1 md:col-end-4"
        ...
        <button
          onClick={closeDialog}
          className="flex justify-center md:row-start-1 md:col-start-3"
        >
